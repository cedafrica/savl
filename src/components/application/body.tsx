...
const Body: React.FC<BodyProps> = ({ contents }) => {
  return (
    <>
      {/* ================= SEO ================= */}
      <SEO
        title="About Spectra AVL — Professional AV Integration Across Africa"
        description="Spectra AVL is a professional audiovisual integration company delivering world-class audio, video, lighting, and control systems for commercial, hospitality, worship, and entertainment spaces across Africa."
        keywords={[
          "Spectra AVL",
          "AV integration company Africa",
          "professional audio systems",
          "video walls and projection",
          "architectural lighting design",
          "commercial AV solutions",
          "hospitality AV integration",
          "worship centre audio video",
