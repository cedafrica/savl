...
const ServicesPage = () => {
  ...
  return (
    <>
      {/* ================= SEO ================= */}
      <SEO
        title="AV Services — Audio, Video & Lighting Integration | Spectra AVL"
        description="Spectra AVL delivers professional audio systems, LED video walls, projection, architectural lighting, and full AV integration for worship spaces, hospitality, nightlife, and commercial environments across Africa."
        keywords={[
          ...
          "audio visual company Nigeria",
          "AV consultants Africa",
            ...
            {data.map((item, i) => (
              ...
              >
                ...
                >
                  <motion.img
                    src={item.image}
                    alt={`${item.title} AV services by Spectra AVL`}
