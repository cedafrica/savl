    ...
    <div className="relative z-10 sm:px-32 h-fit px-10 my-auto sm:pt-88 sm:pb-[19.1rem] pb-8">
        <MaxContainer className="flex flex-col">
            ...
            >
                ...
                <h1 className="text-white text-[3.2rem] leading-[120%] sm:text-[4.2rem] font-bold">
                    {currentSlideData.title}
                </h1>

                <p className="text-white/60 mb-6 sm:w-[90%] mt-10 text-[1.4rem] sm:text-[2rem]">
                    {currentSlideData.description}
                </p>

                <a href={currentSlideData.ctaLink}>
  <Button
    className="sm:text-[1.6rem] w-fit text-[1.2rem] border px-8! py-8! rounded-[3rem] border-white mt-[1.8rem] bg-transparent text-white hover:bg-white! cursor-pointer hover:text-black! sm:w-fit"
  >
