...
const BuiltOnExcellence = () => {
  ...
  const projects = [
    { no: "500+", text: "Projects Completed" },
    { no: "15+", text: "Years of Experience" },
    { no: "100+", text: "Global Partners" },
    { no: "98%", text: "Clients Satisfaction" }
  ];
      ...
      <MaxContainer>
        ...
        <div className="grid sm:grid-cols-3 gap-[3rem] sm:gap-[4rem] mt-[4rem] sm:mt-[7rem]">
          {partners.map((partner, index) => (
            <motion.div
              key={index}
              className="flex items-start sm:items-center gap-[1.6rem] sm:gap-[2.4rem] text-black"
              variants={fadeUp}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
            ...
            >
              ...
              />
              <div>
                <h3 className="sm:text-[2rem] text-[1.8rem] font-semibold leading-snug">
                  {partner.name}
                </h3>
                <p className="sm:text-[1.8rem] text-[1.5rem] opacity-70 leading-snug">
                  {partner.text}
                </p>
              </div>
            </motion.div>
        ...
        <div className="relative flex flex-col-reverse sm:flex-row items-center sm:gap-16 mt-24 sm:mt-48">
          ...
          <div className="flex flex-col sm:w-1/2 text-gray-900 space-y-8 sm:space-y-12">
            <motion.h2
              className="sm:text-[4.8rem] text-[2.8rem] font-extrabold leading-tight text-center sm:text-left tracking-tight"
              variants={fadeUp}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
            ...
            <motion.p
              className="sm:text-[1.9rem] text-[1.6rem] text-gray-700 leading-relaxed text-center sm:text-left"
              variants={fadeUp}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
            ...
            <motion.div
              ...
              custom={7}
            >
              <CustomButton className="mt-8 sm:mt-12 px-12 sm:px-16 py-4 sm:py-5 rounded-full border-[1.5px] border-gray-900 text-gray-900 font-medium hover:bg-gray-900 hover:text-white transition-all shadow-md hover:shadow-lg">
                Learn More
              </CustomButton>
            </motion.div>
          </div>
          ...
          >
            <img
              ...
              className="w-full max-w-[60rem] shadow-2xl object-cover"
            />
          </motion.div>
        </div>
      </MaxContainer>
