...
const PremiumSolution = () => {
  ...
  {/* Heading */}
  <motion.h2
    className="text-left sm:text-center font-semibold sm:text-[4rem] text-[3rem]"
    variants={fadeUp}
    initial="hidden"
    whileInView="visible"
    viewport={{ once: true }}
  ...
  {/* Description */}
  <motion.p
    className="text-left sm:text-center sm:mx-auto sm:max-w-full mt-4 sm:text-[1.6rem] text-[1.6rem]"
    variants={fadeUp}
    initial="hidden"
    whileInView="visible"
    viewport={{ once: true }}
